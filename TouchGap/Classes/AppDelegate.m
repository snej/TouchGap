...
@synthesize window, viewController, database;
...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
        ...
        NSLog(@"TouchGap launchOptions = %@", url);
    }
...
// only valid if TouchGap-Info.plist specifies a protocol to handle
